...
public class TermView extends EmulatorView {
	...
	{
	if(id== R.string.selected_and_copy)
	{
	...
	public void showMenu(ContextMenu menu)
	{
		...
		MenuItem item1= menu.add(0, R.string.selected_and_copy, 0, R.string.selected_and_copy);
		item1.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener()
			{
				...
				{
					onContextMenuSelected(p1);
					return true;
				}
				
			
		});
		MenuItem item2= menu.add(0, android.R.id.paste, 0, android.R.string.paste);
